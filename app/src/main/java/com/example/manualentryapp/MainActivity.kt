...
class MainActivity : AppCompatActivity() {
    ...
    private fun calculateEntries() {
        ...
        // Getting to the base (Total 60 hours)
        ...
        // Getting back to the truck (Total 60 hours backwards from insertion)
        ...
        result.append("\n").append(getString(R.string.label_vacation)).append("\n")
        result.append("${dateTimeFormat.format(r4.time)} - ${dateTimeFormat.format(i0.time)} $vacBed\n")
